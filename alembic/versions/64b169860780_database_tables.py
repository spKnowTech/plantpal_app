...
Revision ID: 64b169860780
Revises: 
Create Date: 2025-08-13 14:11:09.743305
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['completed_by_user_id'], ['users.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['plant_id'], ['plants.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
